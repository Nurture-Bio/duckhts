...
test_release: test-cache-paths test-duckvep-kernel test-simd-kernels test-somalier-native test-somalier-pinned-helper test-somalier-statistical test-somalier-upstream-staging test-liftover-property test-liftover-fuzz test-bcftools-filter-recovery test-sqllogictest-release test-bcf-info-oom
...
.PHONY: test-somalier-native test-somalier-native-asan test-somalier-native-ubsan test-somalier-pinned-helper test-somalier-statistical test-somalier-upstream-source test-somalier-upstream-staging

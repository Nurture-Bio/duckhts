...
- Add `input_quality_encoding` to `rduckhts_fastq()` for explicit FASTQ legacy quality decoding and expose `rduckhts_detect_quality_encoding()` for heuristic FASTQ encoding inspection.
